...
contract Pionera {
    ...
    IERC20 public depositToken = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);         //add BUSD address here
    ...
    function buyLevel(uint _level, uint256 amountSent) public {
        ...
        if(_level == 1 || users[msg.sender].currentLevel == 9) {
            require(amountSent == LEVEL_PRICE[1], 'Incorrect Value');
            require(_level == 1, "You can only buy Level 1 at this stage");    //TODO // make sure only level 1 can be bought at start or after level 9
        }
        else {
